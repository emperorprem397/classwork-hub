...
// Track whether we've already processed a redirect result to avoid double-processing
...
// Delay this slightly to avoid race with redirect result processing.
setTimeout(() => {
  onAuthStateChanged(auth, async (user) => {
    // Only process onAuthStateChanged if we haven't already processed a redirect
